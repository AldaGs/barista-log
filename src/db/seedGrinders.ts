...
export const SEED_GRINDERS: SeedGrinder[] = [
  ...
  { name: '1Zpresso K-Ultra', type: 'hand', burr: 'conical', micronsPerClick: 12.5, maxClicks: 90, source: 'manufacturer' },
  { name: '1Zpresso J-Ultra', type: 'hand', burr: 'conical', micronsPerClick: 8, maxClicks: 100, source: 'manufacturer (48mm burrs)' },
  { name: '1Zpresso Q2 / Q-Air', type: 'hand', burr: 'conical', micronsPerClick: 24, maxClicks: 30, source: 'community' },
  { name: '1Zpresso X-Ultra', type: 'hand', burr: 'conical', micronsPerClick: 12.5, maxClicks: 96, source: 'community (3-part dial, est.)', estimated: 1 },
  { name: 'Kingrinder K6', type: 'hand', burr: 'conical', micronsPerClick: 16, maxClicks: 60, source: 'manufacturer' },
  { name: 'Kingrinder K2', type: 'hand', burr: 'conical', micronsPerClick: 18, maxClicks: 50, source: 'manufacturer' },
  ...
  { name: 'Fellow Ode (Gen 1)', type: 'electric', burr: 'flat', micronsPerClick: 30, maxClicks: 31, source: 'community (est.)', estimated: 1 },
  { name: 'Fellow Opus', type: 'electric', burr: 'flat', micronsPerClick: 23, maxClicks: 41, source: 'community (230–1160µm, est.)', estimated: 1 },
  { name: 'OXO Brew Conical Burr', type: 'electric', burr: 'conical', micronsPerClick: 60, maxClicks: 15, source: 'community (est.)', estimated: 1 },
